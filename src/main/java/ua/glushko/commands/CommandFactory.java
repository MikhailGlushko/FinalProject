...
public class CommandFactory {
    ...
    private static final String COMMAND_NAME_USERS_READ = "users_detail";
    private static final String COMMAND_NAME_USERS_ACTION_CRUD = "users_action";
    private static final String COMMAND_NAME_USERS_ADD = "users_add";
    ...
    private static final String COMMAND_NAME_SERVICES_READ = "services_detail";
    private static final String COMMAND_NAME_SERVICES_ACTION_CRUD = "services_action";
    private static final String COMMAND_NAME_SERVICES_ADD = "repairservices_add";
    ...
    private static final String COMMAND_NAME_ORDERS_ACTION_CRUD = "orders_action";
    private static final String COMMAND_NAME_ORDERS_ADD = "orders_add";
    ...
    private static final String COMMAND_NAME_HISTORY_ACTION_CRUD = "history_action";
    ...
    public static final String COMMAND_NAME_HISTORY_CHANGE_GUEST_BOOK = "history_change_guest_book";

    // for guest book
    public static final String COMMAND_NAME_GUEST_BOOK = "guestbook";
    public static final String COMMAND_NAME_GUEST_BOOK_NEW = "gestbook_new";
    ...
    private CommandFactory() {
        ...
        commandMap.put(COMMAND_NAME_HISTORY_CHANGE_GUEST_BOOK, new OrderHistoryChangeGuestBookCommand());

        commandMap.put(COMMAND_NAME_GUEST_BOOK, new GuestBookListCommand());
        commandMap.put(COMMAND_NAME_GUEST_BOOK_NEW, new GuestBookNewCommand());
