...
public class OrderHistoryChangeDateCommand implements Command {
    @Override
    ...
    private void storeHistoryDataToDatabase(HttpServletRequest request) throws TransactionException, ParseException, ParameterException, DatabaseException {
        ...
        orderHistory.setAction(Action.CHANGE_DATE.name());
        String requestParameter = request.getParameter(PARAM_NAME_ORDER_HISTORY_EXPECTED_DATE);
