...
public class UsersCommandHelper {
    ...
    static final String PARAM_NAME_USER    = "user_detail";
    static final String PARAM_NAME_USER_LIST = "users_list";
    static final String PARAM_NAME_USER_LIST_TITLE = "users_list_head";

    static final String PATH_PAGE_USERS_DETAIL = "path.page.usersdetail";
    static final String PATH_PAGE_USERS_SETUP = "path.page.userssetup";
