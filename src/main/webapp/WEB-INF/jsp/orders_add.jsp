            ...
            <div class="login_div" align="center">
                <form name="edit" method="post" action="/do">
                    ...
                    <div class="row">
                        <div class="input-field">
                            <input id="order_description_short" type="text" name="order_description_short" value="" required/>
                            <label for="order_description_short"><fmt:message key="order.description.short"/></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field">
                            <textarea id="order_description_detail" type="text" name="order_description_detail" value="" required style="height: 100px"></textarea>
                    ...
                    <div class="row">
                        <div class="input-field">
                            ...
                            <select id="order_repair_service" name="order_repair_servive" value="" required>
                    ...
                    <div class="row">
                        <div class="input-field">
                            <input id="order_order_date" type="date" name="order_order_date" value="" required/>
                            <label for="order_order_date"><fmt:message key="order.order.date"/></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field">
                            <input id="order_time" type="text" name="order_time" value="" required/>
                    ...
                    <div class="row">
                        <div class="input-field">
                            <input id="order_paid_method" type="text" name="order_paid_method" value="" required/>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field">
                            <textarea id="order_memo" type="text" name="order_memo" value="" required style="height: 100px"></textarea>
                ...
                ${errorMessage}
                    ...
                    <div class="row">
                            ...
                            <button name="action" class="mainmenubutton" type="button" value="cancel" onClick="window.location.href='/do?command=orders'">
